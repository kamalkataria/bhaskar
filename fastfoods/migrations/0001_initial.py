# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-04-06 15:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Product',
            fields=[
                ('product_id', models.AutoField(db_index=True, primary_key=True, serialize=False)),
                ...
                ('product_price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency=b'INR', max_digits=12)),
                ('product_description', models.TextField()),
                ('product_image', models.ImageField(upload_to='uploads/')),
                ('product_cat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fastfoods.Category')),
            ],
        ),
    ]
